...
function MyAccount(props) {
  ...
  const editCustomer = (idcliente) => {
    axios.put(`http://localhost:8080/${idcliente}`, customer)
    .then((response) => {
          ...
          <div className="modal-content">
                    ...
                    <div className="cardContentAccount row rowCentralized">
                      <div className="col-12">
                        ...
                        <input
                          ...
                          id="inputAddressNome"
                          placeholder={customer.nomeCliente}
                          onChange={(event) => {setCustomer({...customer, nomeCliente: event.target.value})}}
                        />
                      </div>
                      ...
                      <div className="col-12 col-md-12 col-xl-5 ">
                        ...
                        <input
                          ...
                          placeholder={customer.ddd}
                          onChange={(event) => {setCustomer({...customer, ddd: event.target.value})}}
                        />
                      </div>
                      ...
                      <div className="col-12 col-md-12 col-xl-5 responsive-inputA">
                        ...
                        <input
                          value={customer.numeroTelefone}
                          type="text"
                          className="form-control"
                          id="inputCelular"
                          placeholder={customer.numeroTelefone}
                          onChange={(event) => {setCustomer({...customer, numeroTelefone: event.target.value})}}
                        />
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="cardContentAccount rowCentralized row modalEndereco">
                    <div className="col-12 col-md-12 col-xl-9">
                      ...
                      <input
                        ...
                        className="form-control"
                        id="inputEndereco"
                        placeholder={address.nomeRua}
                        onChange={(event) => {setCustomer({...address, nomeRua: event.target.value})}}
                      />
                    </div>
            ...
            <div className="modal-footer">
              ...
              <button
                ...
                data-bs-dismiss="modal"
                onClick={() => editCustomer(customer.idcliente)}
              >
                Salvar
              </button>
            </div>
