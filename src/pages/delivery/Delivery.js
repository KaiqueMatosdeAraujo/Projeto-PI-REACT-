...
import card from './imgs/cartao-multibanco.png'
...
function Delivery(props) {
  ...
  const getAddress = () => {
    axios.get(`http://localhost:8080/endereco/1/1`)
    .then((response) => {
      setOneAddress(response.data)
  ...
  const getPagamento = () => {
      ...
      .then((response) => {
       ...
       setCodPagamento(response.data[0].codPagamento)
      })
  }
  ...
  //   } 
    ...
    // const addPagamento = (event) => {
    //   setFormaPagamento(getPagamento())
    //   addOrder(formaPagamento)
    //   localStorage.setItem("order", formaPagamento)
    //   console.log(formaPagamento)
    // }

  // const getPedido = () => {
  //   axios.get(`http://localhost:8080/endereco/1/meusPedidos`)
  //   .then((response) => {
