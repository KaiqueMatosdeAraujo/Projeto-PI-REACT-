...
function Delivery(props) {
    ...
    // const getOrders = () => {
    //     axios.get('http://localhost:8080/pedido/6/1')
    //     .then((response) => {
                ...
                return (
                    <>
                        <div className="resumo2 col-11">
                            <ProductCheckoutSimple nameProduct={item.nome} qtd={item.quantidade} price={item.preco} />
                        </div>
                    </>
                )
            })
                ...
                return(
                    <>
                        <div className="row  rowCentralized justify-content-center ">
                            <CheckoutProduct name={item.nome} qtd={1} price={item.preco} image={item.imgProduto} />
                        </div>
                    </>
                )
            })
                                        ...
                                        <div className="modal-content">
                                            ...
                                            <div className="textBoleto">
                                                ...
                                                <div className="row">
                                                    <div className="col-12">
                                                        <ul type="none">
                                                            <li>O boleto bancário será gerado no CPF: <strong>568.********</strong> </li>
