        ...
        <div className='row'>
            <div className="Principal" >
                ...
                <div className='lh-base containerPrincipal1'>
                    ...
                    <p><strong >a)</strong> Desprendimento espontâneo de membros ou cabeça do corpo da boneca, exceto no caso de segurar a Bebê pelos membros ou cabeça ou qualquer outro movimento agressivo.</p>
                ...
                <div className='lh-base containerPrincipal'>
                    ...
                    <br />
                    <p style={{fontWeight: 'bold'}}>Atualização: 26 de Dezembro de 2021</p>
                    <br />
                    <p style={{fontWeight: 'bold'}}>PIMPOLHOS</p>
            </div>
        </div>
