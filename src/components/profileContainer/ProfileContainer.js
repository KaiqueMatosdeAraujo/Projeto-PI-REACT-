...
<ul className="nav nav-tabs margin-tab" id="myTab" role="tablist">

  <li className="nav-item principal" role="presentation">
    <button className="nav-link principal active col-12" id="home-tab" data-bs-toggle="tab" data-bs-target="#home"
